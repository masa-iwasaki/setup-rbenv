...
function intallRbenv(options) {
    return __awaiter(this, void 0, void 0, function* () {
        yield exec.exec('sudo', ['git', 'clone', '--depth', '1', 'https://github.com/rbenv/rbenv.git', options.rbenvRoot]);
    });
}
...
function installRubyBuild(options) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield exec.exec('sudo', ['git', 'clone', '--depth', '1', 'https://github.com/rbenv/ruby-build.git', rubyBuildInstallPath]);
